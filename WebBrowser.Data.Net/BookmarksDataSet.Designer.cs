...
namespace WebBrowser.Data.Net.BookmarksDataSetTableAdapters {
    ...
    public partial class BookmarksTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [Bookmarks] SET [Title] = @Title, [URL] = @URL WHERE (([Id] = @Original_Id" +
                ...
                "e, URL FROM Bookmarks WHERE (Id = @Id)";
        ...
        public virtual int Update(string Title, string URL, int Original_Id, string Original_Title, string Original_URL, int Id) {
            if ((Title == null)) {
                throw new global::System.ArgumentNullException("Title");
            }
            else {
        ...
        public virtual int Update(string Title, string URL, int Original_Id, string Original_Title, string Original_URL) {
            return this.Update(Title, URL, Original_Id, Original_Title, Original_URL, Original_Id);
        }
    }
