...
namespace WebBrowser.Data.Net {
    ...
    public partial class HistoryDataSet : global::System.Data.DataSet {
        ...
        public partial class HistoryDataTable : global::System.Data.TypedTableBase<HistoryRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public HistoryRow AddHistoryRow(string Title, string URL, System.DateTime Date) {
...
namespace WebBrowser.Data.Net.HistoryDataSetTableAdapters {
    ...
    public partial class HistoryTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [History] WHERE (([Id] = @Original_Id) AND ([Title] = @Original_Title" +
                ") AND ([URL] = @Original_URL) AND ([Date] = @Original_Date))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [History] ([Title], [URL], [Date]) VALUES (@Title, @URL, @Date);\r\nSEL" +
                "ECT Id, Title, URL, Date FROM History WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [History] SET [Title] = @Title, [URL] = @URL, [Date] = @Date WHERE (([Id] " +
                "= @Original_Id) AND ([Title] = @Original_Title) AND ([URL] = @Original_URL) AND " +
                "([Date] = @Original_Date));\r\nSELECT Id, Title, URL, Date FROM History WHERE (Id " +
                "= @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::WebBrowser.Data.Net.Properties.Settings.Default.BrowserDBConnectionString;
        }
        ...
        public virtual int Delete(int Original_Id, string Original_Title, string Original_URL, System.DateTime Original_Date) {
        ...
        public virtual int Insert(string Title, string URL, System.DateTime Date) {
            if ((Title == null)) {
        ...
        public virtual int Update(string Title, string URL, System.DateTime Date, int Original_Id, string Original_Title, string Original_URL, System.DateTime Original_Date, int Id) {
            if ((Title == null)) {
                throw new global::System.ArgumentNullException("Title");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Title, string URL, System.DateTime Date, int Original_Id, string Original_Title, string Original_URL, System.DateTime Original_Date) {
            return this.Update(Title, URL, Date, Original_Id, Original_Title, Original_URL, Original_Date, Original_Id);
        }
    }
